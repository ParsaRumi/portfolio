          ...
          <Col xs="12" className="cartCol">
            ...
            <div className="cartSubheaderDiv">
              <div className="cartSubheader">
                <h3 className="cartThanks1">Order History</h3>
                <span >
              ...
              <ul className="cartUlList">
                  ...
                  {order.orderItems?.map((item,index)=>{
                    return <li  key={index} className="cartItem">
                      ...
                      <span className="cartItemName1">{item.product.name}</span>
                      <span className="cartItemName1">{item.qty} Qty</span>
                      <span className="cartItemPrice">${item.qty*item.product.price}</span>
                    </li>
                   })}
